...
def main():
    ...
    fastapi_url = "https://fastapi-teams-handler.onrender.com/teams/interact"
        ...
        "actions": [
            {
                ...
                "card": {
                    ...
                    "body": [
                        ...
                        {
                            "type": "TextBlock",
                            "text": f"[View Workflow Run]({workflow_url})"
                        },
                        {
                            "type": "TextBlock",
                            "text": f"[View Error Logs]({error_log_url})"
                        }
                    ]
                }
            },
            {
                ...
                "url": f"{fastapi_url}?action=rerun&run_id={run_id}&user={actor}"
            }
        ],
